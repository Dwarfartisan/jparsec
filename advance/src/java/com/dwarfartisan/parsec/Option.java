 ...
 */
public class Option<T, E, Status, Tran> implements Parsec<Optional<T>, E, Status, Tran> {
    ...
    @Override
    public Optional<T> parse(State<E, Status, Tran> s) throws EOFException, ParsecException {
        try{
